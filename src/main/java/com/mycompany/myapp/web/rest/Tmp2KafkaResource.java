...
@RestController
@RequestMapping("/api/tmp-2-kafka")
public class Tmp2KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Tmp2KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Tmp2KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
